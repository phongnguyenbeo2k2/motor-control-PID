...
#define E_OF                    0xAA
#define ESC                     0x7D
#define MAX_RAW_DATA_TX         (4*3 + 1)       /*send PID 4*3 of data and 1 byte for mode, 1 byte for length of raw data*/
#define MAX_RAW_DATA_RX         (4 + 1)     /*raw data is consist of 4 bytes data for velocity or position and 1 byte mode, 1 byte lenght of raw data */
